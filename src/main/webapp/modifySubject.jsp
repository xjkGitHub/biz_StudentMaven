        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="modifySubject.jsp">ModifySubject</a>
                    </li>
            ...
            <div class="page-content">
                ...
                <form class="form-horizontal" action="${pageContext.request.contextPath}/modifySubject.action" method="post">

                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right"> SubjectId </label>

                        <div class="col-sm-9">
                            <input type="text"  name = "SubjectId" value="${subject.subjectId}" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text"  name = "SubjectName" value="${subject.subjectName}" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text"  name = "SubjectNum" value="${subject.subjectNum}" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text"  name = "SubjectAvgScore"value ="${subject.subjectAvgScore}" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
