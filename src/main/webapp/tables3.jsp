        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/getAllSubject.action">SubjectManage</a>
                    </li>
                                    ...
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <c:forEach items="${subjects}" var="subject">
                                            <tr>
                                                ...
                                                <td><c:out value="${subject.subjectNum}"></c:out></td>
                                                <td><c:out value="${subject.subjectAvgScore}"></c:out></td>
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">

                                                        <a class="btn btn-xs btn-info" href="${pageContext.request.contextPath}/searchSubject.action?id=${subject.subjectId}">
                                                            <i class="icon-edit bigger-120"></i>
                                                        </a>

                                                        <a class="btn btn-xs btn-danger" href="${pageContext.request.contextPath}/deleteSubject.action?id=${subject.subjectId}">
