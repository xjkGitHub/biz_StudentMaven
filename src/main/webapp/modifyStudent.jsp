        ...
        <div class="main-content">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/modifyStudent.action">modifyStudent</a>
                    </li>
            ...
            <div class="page-content">
                ...
                <form class="form-horizontal" action="${pageContext.request.contextPath}/modifyStudent.action" method="post">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Id </label>

                        <div class="col-sm-9">
                            <input type="text"  name = "Id" value="${student.id}" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-2" name = "studentId" value="${student.studentId}" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-1" name="name" value="${student.name}" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="Date"  name = "birthday" id="form-field-3"  class="col-xs-10 col-sm-5" value = "${student.birthday}"/>
                        </div>
                    </div>
                    <div class="form-group">
